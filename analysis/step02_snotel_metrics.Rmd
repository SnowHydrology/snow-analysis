...
In case we have any bandwidth issues, I have saved a version of this dataframe that we can re-import if needed. First, we'll select just the columns we need.
